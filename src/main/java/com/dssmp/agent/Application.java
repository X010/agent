...
import com.dssmp.agent.config.AgentOptions;
...
import com.dssmp.agent.tailing.FileTailer;
import com.dssmp.agent.tailing.checkpoints.FileCheckpointStore;
import com.dssmp.agent.tailing.checkpoints.SQLiteFileCheckpointStore;
 ...
 * Hello world!
 */
public class Application extends AbstractIdleService implements IHeartbeatProvider {
    ...
    public static void main(String[] args) throws Exception {
        ...
        final Logger logger = Logging.getLogger(Application.class);
        ...
        try {
            ...
            final Application agent = new Application(agentContext);
    ...
    public Application(AgentContext agentContext) {
        this.logger = Logging.getLogger(Application.class);
        ...
        this.heartbeat = new HeartbeatService(this.agentContext, 1, TimeUnit.SECONDS) {
            ...
            protected Object heartbeat(AgentContext agent) {
                return Application.this.heartbeat(agent);
            }
        ...
        this.metricsEmitter = new AbstractScheduledService() {
            ...
            protected void runOneIteration() throws Exception {
                Application.this.emitStatus();
            }

            @Override
            protected Scheduler scheduler() {
                return Scheduler.newFixedRateSchedule(Application.this.agentContext.logStatusReportingPeriodSeconds(),
                        Application.this.agentContext.logStatusReportingPeriodSeconds(), TimeUnit.SECONDS);
            }

            @Override
            protected String serviceName() {
                return Application.this.serviceName() + ".MetricsEmitter";
            }

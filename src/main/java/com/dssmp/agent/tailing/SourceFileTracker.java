...
import com.dssmp.agent.tailing.checkpoints.FileCheckpoint;
...
public class SourceFileTracker {
    ...
    public TrackedFile getCurrentOpenFile() {
        return currentOpenFile;
    }

    public void setCurrentOpenFile(TrackedFile currentOpenFile) {
        this.currentOpenFile = currentOpenFile;
    }

    public int getCurrentOpenFileIndex() {
        return currentOpenFileIndex;
    }

    public void setCurrentOpenFileIndex(int currentOpenFileIndex) {
        this.currentOpenFileIndex = currentOpenFileIndex;
    }

    public TrackedFileList getPendingFiles() {
        return pendingFiles;
    }

    public void setPendingFiles(TrackedFileList pendingFiles) {
        this.pendingFiles = pendingFiles;
    }

    public TrackedFileList getCurrentSnapshot() {
        return currentSnapshot;
    }

    public void setCurrentSnapshot(TrackedFileList currentSnapshot) {

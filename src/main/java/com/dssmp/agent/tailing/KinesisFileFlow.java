...
public class KinesisFileFlow extends FileFlow<KinesisRecord> {
    ...
    @Getter
    protected final KinesisConstants.PartitionKeyOption partitionKeyOption;

    public KinesisConstants.PartitionKeyOption getPartitionKeyOption() {
    ...
    public KinesisFileFlow(AgentContext context, Configuration config) {
        ...
        partitionKeyOption = readEnum(KinesisConstants.PartitionKeyOption.class, KinesisConstants.PARTITION_KEY, KinesisConstants.PartitionKeyOption.RANDOM);
    }
